...
\restrict 8OPYQuXHmR8Yg2Gt65BW1kphdhCCP0eEqiMqRKY4Ceo9bOtrg7vDJh2qLNewgTC
...
--
-- Name: COLUMN noticias.data_agendada; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.noticias.data_agendada IS 'Data e hora agendada para publicação automática';
...
--
-- Name: noticias noticias_slug_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: noticias noticias_autor_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.noticias
    ADD CONSTRAINT noticias_autor_foreign FOREIGN KEY (autor) REFERENCES public.autores(id);
...
\unrestrict 8OPYQuXHmR8Yg2Gt65BW1kphdhCCP0eEqiMqRKY4Ceo9bOtrg7vDJh2qLNewgTC
