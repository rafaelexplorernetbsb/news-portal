-- Script SQL completo para corrigir as coleções do Directus
-- Remove registros existentes e recria tudo do zero

-- Remover registros existentes das coleções (se existirem)
...
ON CONFLICT (many_collection, many_field) DO UPDATE SET
    ...
    one_field = EXCLUDED.one_field;

-- Aplicar permissões básicas (remover existentes primeiro)
